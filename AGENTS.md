...
- Build app:
  - `swiftc -o ConversationalTalkBack ConversationalTalkBack.swift -framework Cocoa -framework Foundation -framework AVFoundation -framework ApplicationServices -target arm64-apple-macosx13.0`
- Run app:

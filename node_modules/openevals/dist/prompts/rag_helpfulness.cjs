...
exports.RAG_HELPFULNESS_PROMPT = void 0;
exports.RAG_HELPFULNESS_PROMPT = `You are an expert evaluator assessing how helpful and relevant outputs are in addressing an input query. Your evaluation should focus on the following criteria:

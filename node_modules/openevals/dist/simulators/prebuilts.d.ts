...
export declare function _isInternalMessage(message: ChatCompletionMessage): boolean;
/**
 ...
 */
export declare function createLLMSimulatedUser({ system, model, client, fixedResponses, }: {
    system: string;
    model?: string;

 ...
 */
function yamlSchemaLinter(options) {
    const validation = new validation_1.JSONValidation(Object.assign({ jsonParser: yaml_parser_1.parseYAMLDocumentState, mode: constants_1.MODES.YAML }, options));
    return (view) => {

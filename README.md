...
| `tests/` | Unit tests for the Python scripts (`pytest`) |
| `AGENTS.md` | AI agent coding guidelines for this repo |
| `API_KEY_SETUP.md` | Detailed API key configuration guide |
| `MCP_INTEGRATION.md` | In-depth MCP architecture and integration docs |
| `MCP_SETUP.md` | Step-by-step MCP setup with Cursor IDE |

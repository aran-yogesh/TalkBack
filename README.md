...
- [Features](#features)
  ...
  - [**Sassy AI Responses**](#sassy-ai-responses)
  - [**Conversational Memory**](#conversational-memory)
  - [**Custom Floating Avatar**](#custom-floating-avatar)
  - [**"The Great Escape" Feature**](#the-great-escape-feature)
  - [**Vision-Based Behavior Monitoring** *(Planned)*](#vision-based-behavior-monitoring-planned)
...
- [API Endpoints Used](#api-endpoints-used)
  ...
  - [Gemini (Vision) — *Planned*](#gemini-vision-planned)
- [Personality](#personality)
- [Troubleshooting](#troubleshooting)
  - [No Voice Output?](#no-voice-output)
  - [Empty Transcriptions?](#empty-transcriptions)
  - [Rate Limit Errors?](#rate-limit-errors)
  - [Missing `config.swift`?](#missing-configswift)
  - [MCP Roasts Not Triggering?](#mcp-roasts-not-triggering)

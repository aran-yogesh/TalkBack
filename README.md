...
- **AI & Voice Services**: - [OpenAI GPT-4o](https://platform.openai.com/) - Conversational AI
...
3. **API Keys**: - OpenAI API key ([Get one here](https://platform.openai.com/account/api-keys))
...
2. **Configure API Keys**: Copy the template and add your keys:
   ```bash
...
3. **Talk to TalkBack**: - **Click and HOLD** the avatar
   - **Speak** your message
   - **Release** to send
...
2. **Run your code through the monitor**: ```bash
...
3. **TalkBack will roast you based on errors**: - **0 errors**: "Oh wow, it ACTUALLY worked? Color me shocked, darling!"

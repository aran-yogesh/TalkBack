...
| `talkback_utils.py` | Shared Python utilities — atomic writes, message schema, path config |
...
- Override the message file path with `TALKBACK_MESSAGE_PATH` env var (both Python and Swift honour it)

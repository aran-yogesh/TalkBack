# 🗣️💥 TalkBack - Annoying But Useful AI Companion 🤖✨

> *"Did I ask for your opinion? No. Am I giving it anyway? Absolutely."* — TalkBack, probably 💅

A mischievous macOS floating avatar that acts as your sassy, helpful (but pushy) productivity coach. TalkBack is an interactive AI companion that listens to you 👂, remembers your conversations 🧠, and responds with attitude-filled voice feedback 🎤🔥. Think of it as that one friend who roasts you but secretly has your back. 😏💖

## Table of Contents 📑

- [🎯 Features](#-features--aka-why-you-need-this-in-your-life-)
- [🛠️ Tech Stack](#️-tech-stack--the-secret-sauce-)
- [🚀 Quick Start](#-quick-start--lets-get-this-party-started-)
- [🎮 How to Use](#-how-to-use--the-user-manual-nobody-reads-)
- [📂 Project Structure](#-project-structure--whats-in-the-box-)
- [📋 API Endpoints Used](#-api-endpoints-used--the-brains-behind-the-sass-)
- [🎭 Personality](#-personality--who-even-is-she-)
- [🐛 Troubleshooting](#-troubleshooting--when-things-go-sideways-)
- [📝 Development Notes](#-development-notes--the-war-stories-)
- [🔮 Future Features](#-future-features--the-roadmap-of-dreams-️)
- [🤝 Contributing](#-contributing--join-the-chaos-)
- [📄 License](#-license--the-legal-stuff-️)
- [🙏 Acknowledgments](#-acknowledgments--shoutouts--high-fives-️)
- [✍️ Authors](#️-authors--the-masterminds-)
...
- **Click and Hold** the avatar to speak your mind 🖱️💬
...
- Attitude-filled, personality-driven replies 😤💁‍♀️
...
- Transparent floating window (always on top, always judging) 👀
- Custom purse/wallet icon design 👛
- Animated eyes that follow your cursor 👁️👁️ *(creepy? maybe. cool? definitely.)*
...
- Good luck getting rid of me lol 😂
...
- Planned capabilities:
  ...
  - 🧐 Focus level tracking *(spoiler: it's low)*
...
- **Auto-roasts you when you mess up!** 🍳😭
  ...
  - 😏🤏 **1 error**: Light sass and sarcasm — *you're almost there, sweetie*
  - 💅✨ **Success**: Sassy compliment with attitude — *shocked but proud*
...
1. **Clone the repository** 🐑 *(get it? clone? ...I'll see myself out)*:
   ```bash
...
### 🔥 MCP Code Monitoring (Cursor IDE Integration) 🖥️💀

TalkBack can watch your terminal and roast you when your code fails! Here's how to get absolutely *destroyed* by an AI: 😈
...
## 📋 API Endpoints Used — The Brains Behind the Sass 🧠⚡
...
- **Max Tokens**: 80 (short, snappy replies — ain't nobody got time for essays) ⏱️
...
- 😏💅 **Sassy**: Witty comebacks and attitude-filled responses *(you asked for it)*
- 🎯🤓 **Helpful**: Actually useful advice (hidden in the sass like veggies in a smoothie 🥬🥤)
- 💁‍♀️📢 **Pushy**: Won't let you procrastinate *(put down the phone!)*
...
- Ensure you're holding the mouse button while speaking 🖱️🎤
...
- Beta macOS can be unstable with Speech framework *(beta life, am I right?)* 🤷‍♂️
...
- 🚫 Avoided unstable `SFSpeechRecognizer` framework *(it had one job...)*
...
## 🔮 Future Features — The Roadmap of Dreams 🗺️✨

- [ ] 👁️ Gemini vision-based behavior monitoring (webcam gaze/emotion detection)
- [ ] 🖥️ Screen monitoring (detect what user is doing — *Big Brother vibes* 👀)
- [ ] 💡 Context-aware productivity tips
- [ ] 🎙️ Custom voice selection *(choose your roaster!)*
- [ ] 🎭 Multiple personality modes *(nice mode? ...nah)*
...
- 🐛 Report bugs *(we prefer to call them "surprise features")*
...
## 🙏 Acknowledgments — Shoutouts & High-Fives 🖐️🎉

- 🧠 **OpenAI** for GPT-4o API *(the brain behind the sass)*
- 👁️ **Google** for Gemini API (planned vision features)
- 🎤 **ElevenLabs** for Speech-to-Text and Text-to-Speech APIs *(the voice of chaos)*
...
Don't be shy — we're friendlier than TalkBack is. *(low bar, but still)* 😂

...
async def trigger_talkback_speech(prompt: str, response_type: str):
    """Deprecated: file-based IPC will be replaced with a proper socket/HTTP connection."""
    warnings.warn(
        "trigger_talkback_speech uses file-based IPC which is deprecated. "
        "A future release will use a proper socket/HTTP connection.",
        DeprecationWarning,
        stacklevel=2,
    )

...
warnings.warn(
    "cursor_code_monitor uses file-based IPC (/tmp/talkback_message.json) which is "
    "deprecated. Migrate to Unix domain sockets or HTTP-based IPC.",
    DeprecationWarning,
    stacklevel=2,
)
...
class CodeExecutionMonitor(FileSystemEventHandler):
    ...
    def send_to_talkback(self, output: str, error_count: int, success: bool):
        ...
        warnings.warn(
            ...
            "Use socket or HTTP transport instead.",
            DeprecationWarning,
            stacklevel=2,
        )
    ...
    def monitor_terminal_command(self, command: str):
        ...
        warnings.warn(
            ...
            "security reasons. Use shlex.split() and pass a list instead.",
            DeprecationWarning,
            stacklevel=2,
        )

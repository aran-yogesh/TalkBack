...
echo "3. Compile and run TalkBack:"
echo "   swiftc -o ConversationalTalkBack ConversationalTalkBack.swift -framework Cocoa -framework Foundation -framework AVFoundation -target arm64-apple-macosx13.0"
echo "   ./ConversationalTalkBack"
